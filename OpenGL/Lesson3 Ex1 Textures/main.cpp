...
void PrepareTexture(GLuint& texture, const char* imagePath, GLint imageFormat)
{
...
int main()
{
	...
	PrepareTexture(textureContainer, "container.jpg", GL_RGB);
	PrepareTexture(textureSmile, "awesomeface.png", GL_RGBA);
